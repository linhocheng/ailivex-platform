"""
ailivex-realtime-agent v17 — LiveKit Agent 核心邏輯（= v16 + 記憶全景圖語音道：remote 記憶塊＋掛斷日記，docs/memory-panorama-voice-integration.md）
...
logger = logging.getLogger("ailivex-realtime-v17")
