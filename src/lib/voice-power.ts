...
const CANARY_VOICE_VERSIONS: string[] = ['v19'];  // v19=訓練線（共創，2026-07-22 轉正為常設）；v20 已是 DEFAULT 天然在傘下；v18/v17 冷備不在名單（在名單會被 power-on 復活成 min=1）——v18 於 2026-07-22 v20 觀察期結案後降冷備（回滾坑位保留，需要時改 DEFAULT 回 v18 並先 scale min=1）
