...
export async function GET() {
  ...
  const quota = user.role === 'admin'
    ? { voiceSecondsLimit: null, voiceSecondsUsed: 0, voiceSecondsRemaining: null, docsLimit: null, docsUsed: 0, docsRemaining: null, mediaLimit: null, mediaUsed: 0, mediaRemaining: null }
